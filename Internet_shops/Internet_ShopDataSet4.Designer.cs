...
namespace Internet_shops {
    ...
    public partial class Internet_ShopDataSet : global::System.Data.DataSet {
        ...
        private void InitClass() {
            ...
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/Internet_ShopDataSet4.xsd";
        ...
        public partial class ProductsDataTable : global::System.Data.TypedTableBase<ProductsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public ProductsRow AddProductsRow(string Id, string Name, decimal Price, string UnitMeasurement, int Count) {
    ...
    public partial class ProductsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Products] WHERE (([Id] = @Original_Id) AND ([Price] = @Origina" +
                "l_Price) AND ([Count] = @Original_Count))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Products] ([Id], [Name], [Price], [UnitMeasurement], [Count]) " +
                "VALUES (@Id, @Name, @Price, @UnitMeasurement, @Count);\r\nSELECT Id, Name, Price, " +
                "UnitMeasurement, Count FROM Products WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Products] SET [Id] = @Id, [Name] = @Name, [Price] = @Price, [UnitMeasurement] = @UnitMeasurement, [Count] = @Count WHERE (([Id] = @Original_Id) AND ([Price] = @Original_Price) AND ([Count] = @Original_Count));
SELECT Id, Name, Price, UnitMeasurement, Count FROM Products WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Name, Price, UnitMeasurement, Count FROM dbo.Products";
        ...
        public virtual int Delete(string Original_Id, decimal Original_Price, int Original_Count) {
            if ((Original_Id == null)) {
        ...
        public virtual int Insert(string Id, string Name, decimal Price, string UnitMeasurement, int Count) {
            if ((Id == null)) {
        ...
        public virtual int Update(string Id, string Name, decimal Price, string UnitMeasurement, int Count, string Original_Id, decimal Original_Price, int Original_Count) {
            if ((Id == null)) {
                throw new global::System.ArgumentNullException("Id");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, decimal Price, string UnitMeasurement, int Count, string Original_Id, decimal Original_Price, int Original_Count) {
            return this.Update(Original_Id, Name, Price, UnitMeasurement, Count, Original_Id, Original_Price, Original_Count);
        }
    }
